...
const SignUpPage = (props: Props) => {
	...
	return (
		<div className='outline w-full flex min-h-screen place-items-center '>
			<div className='border container relative min-h-fit w-[80%] rounded-md shadow-lg flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 overflow-hidden'>
				...
				<div className='relative hidden   h-full w-full aspect-square items-center justify-center bg-primary/15 p-10 lg:flex dark:border-r'>
					<Lottie
